...
# Sandboxed coding agents with a web & mobile IDE (Pixcode)

[Docker Sandbox](https://docs.docker.com/ai/sandboxes/) templates that add [Pixcode](https://github.com/alicomert/pixcode) on top of Claude Code, Codex, and Gemini CLI. You get a full web and mobile IDE accessible from any browser on any device.
...
| Agent | Template |
|-------|----------|
| **Claude Code** (default) | `ghcr.io/alicomert/pixcode-sandbox:claude-code` |
| OpenAI Codex | `ghcr.io/alicomert/pixcode-sandbox:codex` |
| Gemini CLI | `ghcr.io/alicomert/pixcode-sandbox:gemini` |
...
```bash
pixcode sandbox ls
pixcode sandbox start my-project    # Restart and re-launch web UI
pixcode sandbox logs my-project     # View server logs
```
...
Restart Pixcode for changes to take effect:

```bash
sbx exec my-project bash -c 'pkill -f "server/index.js"'
sbx exec -d my-project pixcode start --port 3001
```
...
sbx run --template ghcr.io/alicomert/pixcode-sandbox:claude-code claude ~/my-project --name my-project
...
# Multiple workspaces
sbx run --template ghcr.io/alicomert/pixcode-sandbox:claude-code claude ~/project ~/shared-libs:ro

# Pass a prompt directly
sbx run --template ghcr.io/alicomert/pixcode-sandbox:claude-code claude ~/my-project -- "Fix the auth bug"
```

Pixcode auto-starts via `.bashrc` when using `sbx run`.
...
- [Pixcode](https://github.com/alicomert/pixcode) — fully managed, no setup required
- [Documentation](https://github.com/alicomert/pixcode) — full configuration guide
- [Discord](https://discord.gg/buxwujPNRE) — community support
- [GitHub](https://github.com/alicomert/pixcode) — source code and issues
