...
export default function McpServers({ selectedProvider, currentProjects }: McpServersProps) {
  ...
  const globalAddDescription = 'Add Global MCP Server writes one common stdio or HTTP server to Claude, Cursor, Codex, Gemini, Qwen Code, and OpenCode.';
  const providerAddDescription = `${providerButtonLabel} only changes ${providerName}.`;
  const globalModalDescription = 'Adds this MCP server to every provider: Claude, Cursor, Codex, Gemini, Qwen Code, and OpenCode. '
