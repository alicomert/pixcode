 ...
 * bottom of the tab. No longer used to auto-install anything — the old
 * "featured plugin" cards pointed at the main repo URL and fell over in
 * the install flow because the main repo has no plugin manifest.
 */
const PLUGIN_DOCS_URL = 'https://github.com/alicomert/pixcode';
...
export default function PluginSettingsTab() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Footer — only the docs link; the old starter-repo link was removed
          alongside the broken featured cards. */}
